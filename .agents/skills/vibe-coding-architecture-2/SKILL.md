...
**User-provided tech vs. Codex-recommended tech — a critical distinction:**
...
In short: user-stated tech = blueprint input (welcome). Codex-initiated tech = must wait for blueprint confirmation.
