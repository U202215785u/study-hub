...
export default { title: 'Study Hub Widgets/快捷工作流 WorkflowWidget', component: WorkflowWidget, tags: ['autodocs'], parameters: { docs: { description: { component: '首页学习流程，对应 Figma 349:459。运行步骤只抛出步骤 id。' } } }, args: { steps } }
