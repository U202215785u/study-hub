...
export default { title: '仪表盘组件/创作入口 CreationWidget', component: CreationWidget, tags: ['autodocs'], parameters: { docs: { description: { component: '首页继续创作组件，对应 Figma 349:493。打开作品只抛出作品 id。' } } }, args: { items } }
