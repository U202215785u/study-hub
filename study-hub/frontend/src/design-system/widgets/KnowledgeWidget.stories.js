...
export default { title: '仪表盘组件/知识库 KnowledgeWidget', component: KnowledgeWidget, tags: ['autodocs'], parameters: { docs: { description: { component: '首页最近知识列表，对应 Figma 349:471。打开文档只抛出文档 id。' } } }, args: { items } }
