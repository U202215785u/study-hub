...
export default { title: '仪表盘组件/今日任务 TodayFocusWidget', component: TodayFocusWidget, tags: ['autodocs'], args: { tasks, dateLabel: '08月03日' }, parameters: { docs: { description: { component: '2×3 今日任务模块，对应 Figma 349:405；最多显示五项。' } } } }
