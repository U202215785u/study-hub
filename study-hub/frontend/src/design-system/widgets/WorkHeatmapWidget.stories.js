...
export default { title: 'Study Hub Widgets/工作热力 WorkHeatmapWidget', component: WorkHeatmapWidget, tags: ['autodocs'], args: { cells }, parameters: { docs: { description: { component: '4×2 工作热力模块，对应 Figma 349:169；数据变化不改变卡片尺寸。' } } } }
