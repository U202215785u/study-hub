...
export default { title: 'Study Hub/Widgets/CalendarWidget', component: CalendarWidget, tags: ['autodocs'], parameters: { docs: { description: { component: '首页学习日历，对应 Figma 349:516。日期选择只抛出 ISO 日期字符串。' } } }, args: { days, monthLabel: '2026 年 6 月' } }
