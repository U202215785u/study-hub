...
export default { title: '仪表盘组件/日历日程 CalendarAgendaWidget', component: CalendarAgendaWidget, tags: ['autodocs'], args: { monthLabel: '2026年 8月', days, agenda }, parameters: { docs: { description: { component: '2×2 日历与日程模块，对应 Figma 349:516。' } } } }
