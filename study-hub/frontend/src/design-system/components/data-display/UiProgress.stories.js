...
export default {
  ...
  argTypes: {
    type: { control: 'select', options: ['linear', 'segmented'] },
    size: { control: 'select', options: ['default', 'compact'] },
    status: { control: 'select', options: ['active', 'success', 'warning', 'danger'] },
  },
  args: { value: 64, label: '本周目标', size: 'default', status: 'active', showValue: true },
}
...
export const CompactDanger = { args: { size: 'compact', status: 'danger', value: 68, label: '', showValue: false } }
