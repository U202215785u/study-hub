...
def test_document_page_reaches_all_active_documents_in_stable_order():
    ...
    try:
        ...
        first = upload.list_document_page(page_size=50, search="pagination-contract-")
        second = upload.list_document_page(page_size=50, search="pagination-contract-", cursor=first["next_cursor"])
